	...
	return (
		<div className="">
			...
			<div className="flex flex-col h-screen bg-[#0B0C0F]">
				<div className="section mx-auto w-[600px]">
					<div className="pt-5 pb-36 flex flex-row items-center">
						<WhiteKingIcon className="h-24 w-24 text-white" />
						<Label className="text-4xl font-semibold ml-2">Chess</Label>
					</div>
					<div className="mb-10">
						<Label className='text-4xl font-semibold'>Play</Label>
					</div>
					<div className="flex space-x-8 items-center space-x-4">
						<CreateButton />
						<JoinButton />
						<DebugButton></DebugButton>
					</div>
					<div className="mb-10 mt-8">
						<Label className='text-4xl font-semibold'>Completed Games</Label>
					</div>
					<div className="mt-2">
